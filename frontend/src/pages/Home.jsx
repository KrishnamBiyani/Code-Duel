  ...
  return (
    <div className="min-h-screen flex bg-black text-white relative">
      ...
      <div className="flex flex-col justify-center flex-1 px-12 max-w-lg">
        ...
        >
          {isLoading ? "Creating Room..." : "Create Duel Room"}
        </button>
        ...
        <div className="flex gap-4">
          ...
          <button
            ...
            disabled={isLoading}
            className="px-6 py-3 bg-red-700 hover:bg-red-600 disabled:bg-red-800 rounded-lg font-semibold transition-all shadow-[0_0_5px_#dc2626] cursor-pointer"
          >
        ...
        <div className="mt-8">
          <AIChat
            ...
            title="AI Assistant"
            subtitle="Practice DSA concepts before you enter the duel"
          />
        </div>
      </div>
