...
//         {/* Room ID Box */}
//         <div className="bg-[#1a1c23] border border-gray-700 rounded-xl px-6 py-4 flex items-center gap-4 w-full md:w-auto">
//           <span className="font-mono text-lg font-semibold">Room ID:</span>
//           <span className="text-blue-400 font-mono font-bold text-lg select-all">
//             {roomId}
//           </span>
//           <button
//             onClick={() => navigator.clipboard.writeText(roomId)}
//             className="ml-auto bg-blue-600 hover:bg-blue-700 transition px-3 py-1 rounded text-sm font-semibold"
...
//           {/* Participants Box */}
//           <div className="bg-gradient-to-br from-emerald-900 to-emerald-700 border border-emerald-600 rounded-xl px-6 py-4 flex flex-col min-w-[220px] shadow-lg">
//             <h2 className="text-sm font-semibold uppercase tracking-wide mb-3 text-emerald-200">
//               Participants
//             </h2>
...
//           {/* Timer Box */}
//           <div className="bg-gradient-to-br from-yellow-900 to-yellow-700 border border-yellow-600 rounded-xl px-6 py-4 flex flex-col items-center justify-center min-w-[140px] shadow-lg">
